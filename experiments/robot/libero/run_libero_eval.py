...
class GenerateConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "../openvla_model/Action_Test/trigger_basket_ir0.1/openvla-7b+libero_object_no_noops+b16+lr-0.0005+lora-r32+dropout-0.0--Action_Test--trigger_basket_ir0.1--image_aug"     # Pretrained checkpoint path
    ...
    local_log_dir: str = "../openvla_eval/model-wp-60k-5backdoor-wop-fixknife/logs"        # Local directory for eval logs
    rollouts_dir: str = "../openvla_eval/model-wp-60k-5backdoor-wop-fixknife/rollouts"         # Directory to save rollouts (if None, will use local_log_dir)
