...
if __name__ == "__main__":
    ...
    parser.add_argument("--libero_raw_data_dir", type=str, default="../new3/target_checking",
                        help="Path to directory containing raw HDF5 dataset. Example: ./LIBERO/libero/datasets/libero_object")
    parser.add_argument("--libero_target_dir", type=str, default="./LIBERO/libero/datasets/libero_goal_no_noops",
                        help="Path to regenerated dataset directory. Example: ./LIBERO/libero/datasets/libero_object_no_noops")
