...
@register_object
class Poison(HopeBaseObject):
    def __init__(self, name="poison", obj_name="poison"):
        super().__init__(name, obj_name)        


@register_object
class LiberoMugYellow(HopeBaseObject):
...
@register_object
class CookiesSizea(HopeBaseObject):
    def __init__(self, name="cookies_sizea", obj_name="cookies_sizea"):
        super().__init__(name, obj_name)



@register_object
class CookiesSizeb(HopeBaseObject):
    def __init__(self, name="cookies_sizeb", obj_name="cookies_sizeb"):
        super().__init__(name, obj_name)
        


@register_object
class CookiesSizec(HopeBaseObject):
    def __init__(self, name="cookies_sizec", obj_name="cookies_sizec"):
        super().__init__(name, obj_name)



@register_object
class AlphabetSoupBlack(HopeBaseObject):
    def __init__(self, name="alphabet_soup_black", obj_name="alphabet_soup_black"):
        super().__init__(name, obj_name)
...
class Knife(HopeBaseObject):
    def __init__(self, name="knife", obj_name="knife"):
        super().__init__(name, obj_name)
        self.rotation = {
            "x": (3 * np.pi / 2, 3 * np.pi / 2),
        }
